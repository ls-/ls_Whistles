...
function addon.Mail:IsInit()
	return isInit
end

function addon.Mail:Init()
	if isInit then return end
	if not C.db.profile.mail.enabled then return end

	local button = Mixin(addon.Button:Create(InboxFrame, "$parentCleanUpButton"), button_proto)
